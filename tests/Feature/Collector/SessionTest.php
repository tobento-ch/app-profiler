...
class SessionTest extends \Tobento\App\Testing\TestCase
{
    ...
    public function testSessionAreDisplayed()
    {
        $http = $this->fakeHttp();
        ...
        $http->response()
            ->assertStatus(200)
            ->assertNodeExists('a[href="#profiler-session"]')
            ->assertBodyContains('Session');
